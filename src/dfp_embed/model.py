"""ResidualMLP encoder for drug phenotypic embedding."""
...
class ResidualMLP(nn.Module):
    ...
    LayerNorm before L2 normalization prevents gradient vanishing.
    """
    ...
    def __init__(
        ...
        self.head = (
            nn.Linear(prev, embed_dim) if prev != embed_dim else nn.Identity()
        )
